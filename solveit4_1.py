def solveit_4(_input):
    lst_input = [l.split(' ') for l in _input.split('\n')]
    ans = 0
    for sub_l in lst_input:
        cur_pw = set()
        good_pw = True
        for pw in sub_l:
            if pw in cur_pw:
...
solveit_4('''pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
